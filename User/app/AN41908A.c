...
#define SPI_SCK_AN41908A_PIN        GPIO_Pin_12//PA5
...
#define SPI_SOUT_AN41908A_PIN        GPIO_Pin_11//PA6
#define SPI_SOUT_AN41908_PIN_GET    GPIO_ReadInputDataBit(GPIOA, SPI_SOUT_AN41908A_PIN)

#define SPI_SIN_AN41908A_PIN        GPIO_Pin_12
#define SPI_SIN_AN41908A_MODE(VAL)  GPIO_WriteBit(GPIOC, SPI_SIN_AN41908A_PIN,VAL)
...
void an41908a_spi_pin_init(void)
{
	...
	GPIOD_InitStructure.GPIO_Pin = SPI_CS_AN41908A_PIN|SPI_SCK_AN41908A_PIN;
	...
	GPIOD_InitStructure.GPIO_Pin = SPI_VD_FZ_AN41908A_PIN|SPI_VD_IS_AN41908A_PIN|SPI_SIN_AN41908A_PIN;
    GPIOD_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIOD_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
...
//1,on; 0,off
void an41908_motor_on_off(u8 mode)
{
	uint backup_data = 0;
